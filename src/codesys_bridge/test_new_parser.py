...
import unittest
from new_parser import parse_iec_element, remove_comments_and_strings_for_parsing
...
class TestSTParser(unittest.TestCase):
    ...
    def test_function_block_parsing(self):
        ...
        element = parse_iec_element(self.samples['FUNCTION_BLOCK'])
    ...
    def test_struct_parsing(self):
        ...
        element = parse_iec_element(self.samples['TYPE'])
    ...
    def test_gvl_parsing(self):
        ...
        element = parse_iec_element(self.samples['VAR_GLOBAL'])
        self.assertEqual(element.type, 'VAR_GLOBAL')
        self.assertTrue('Speed : REAL' in element.declaration)
        self.assertTrue('Enable : BOOL' in element.declaration)
        self.assertEqual(element.implementation, '')
